...
class LocationControllers {
    ...
    /*updateLocation = async (req: Request, res: Response) => {
        ...
        const response = await Location.updateLocation(parseInt(user_id), parseInt(location_id), {
            latitude,
            longitude,
            adresse,
            user
    ...
    deleteLocation = async (req: Request, res: Response) => {
        ...
        const response = await Location.deleteLocation(parseInt(user_id), parseInt(location_id));
